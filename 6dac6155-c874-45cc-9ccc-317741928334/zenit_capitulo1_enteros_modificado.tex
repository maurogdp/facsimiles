...
\begin{enumerate}[label=\Alph*), leftmargin=14pt, itemsep=2pt, topsep=2pt]
}{\end{enumerate}}
...
\[
\left\{1,0,2,-\dfrac{4}{3},2,\overline{31},\ldots\right\}
\]
...
\[
\left\{i,2i,\sqrt{3}i,\dfrac{2}{3}i,\ldots\right\}
\]
...
\begin{align*}
|a|\cdot |b| &= |ab|,\\
\dfrac{|a|}{|b|} &= \left|\dfrac{a}{b}\right|, \qquad b\neq 0,\\
|a^n| &= |a|^n, \qquad n\in \mathbb{Z}.
\end{align*}
Ejemplos:
\begin{align*}
|5|\cdot |-3| &= |5\cdot(-3)| = 15,\\
\dfrac{|6|}{|-2|} &= \left|\dfrac{6}{-2}\right| = 3,\\
|(-3)^2| &= |-3|^2 = 9.
\end{align*}
...
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
% Sin figura
\end{minipage}};
\end{tikzpicture}
\end{minipage}
...
\item
\begin{minipage}[t]{\linewidth}
La temperatura en una cámara frigorífica es de $12^\circ\mathrm{C}$. Se necesita variar esta temperatura hasta alcanzar los $-36^\circ\mathrm{C}$. Si la temperatura desciende $3^\circ\mathrm{C}$ cada cinco minutos, ¿cuánto tiempo se tardará en alcanzar dicha temperatura?\\
...
\item
\begin{minipage}[t]{\linewidth}
Si la suma de 3 números enteros consecutivos es igual a $p$, ¿cuál de las siguientes afirmaciones es siempre verdadera respecto del valor de $p$?\\
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item Es un número impar.
\item Es múltiplo de 3.
\item Es positivo.
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item Ubicarse en el $-5$ y desplazarse 8 unidades a la izquierda.
\item Ubicarse en el $-5$ y desplazarse 8 unidades a la derecha.
\item Ubicarse en el $-8$ y desplazarse 5 unidades a la derecha.
\item Ubicarse en el $-8$ y desplazarse 3 unidades a la derecha.
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\bloqueheader{B}{blockb}{Ejemplos — ejercicios 6 al 20}

\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=8pt, start=6]
\item
\begin{minipage}[t]{\linewidth}
En la siguiente infografía se presenta el pronóstico del tiempo para cierto día, con la temperatura en grados Celsius.\\
...
\item
\begin{minipage}[t]{\linewidth}
Si al quíntuplo de $-10$ se le resta el triple de $-12$, ¿qué número se obtiene?\\
\textbf{Habilidad:} Resolver problemas. (DEMRE 2024)\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
...
\item
\begin{minipage}[t]{\linewidth}
La automotora \textit{Mi auto} tiene cinco marcas de automóviles; cada marca tiene tres modelos y cada modelo está en tres colores distintos. La automotora \textit{Viaje feliz} tiene cuatro marcas, cada marca tiene tres modelos y cada modelo está en cuatro colores distintos.\\
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item \textit{Viaje feliz} ofrece tres posibilidades más.
\item Ambas ofrecen la misma cantidad de posibilidades.
\item \textit{Mi auto} ofrece más posibilidades.
\item El total se determina por la suma de marcas, modelos y colores.
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
Un diario tiene una colilla recortable para un concurso, la que se presenta a continuación.\\
...
\item
\begin{minipage}[t]{\linewidth}
En la figura se presenta un cartel con los precios de las impresiones en blanco y negro de un centro de impresión.\\
...
\item
\begin{minipage}[t]{\linewidth}
Consuelo y dos amigas comieron en un restaurante. A continuación se presenta la boleta de todo lo consumido.\\
...
\item
\begin{minipage}[t]{\linewidth}
Una persona viaja al exterior con un saldo inicial de \$300.000 en su tarjeta. Realiza un pago de \$15.000 y otro de \$35.000. Por cada pago, el banco cobra una comisión de \$2.000. ¿Cuál es su saldo final?\\
\textbf{Habilidad:} Resolver problemas. (DEMRE 2024)\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
...
\item
\begin{minipage}[t]{\linewidth}
Dos personas realizan rutinas de ejercicio. La primera repite 8 veces una serie de 2 minutos de ejercicio y 30 segundos de descanso. La segunda repite 12 veces una serie de 1 minuto y 30 segundos de ejercicio y 15 segundos de descanso. ¿Qué argumento garantiza que una termina antes que la otra?\\
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item Que la cantidad de repeticiones es distinta.
\item Que los tiempos de descanso son distintos.
\item Que la suma entre tiempo de ejercicio, descanso y repeticiones es distinta.
\item Que la suma entre ejercicio y descanso, multiplicada por la cantidad de repeticiones, es distinta.
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
Considera la siguiente secuencia de figuras, formadas por cuadrados y triángulos con palitos de fósforo.\\
...
\item
\begin{minipage}[t]{\linewidth}
Un juego consiste en lanzar cinco bolitas hacia los agujeros de una caja, con distintos puntajes según el agujero por donde entra cada bolita.\\
...
\item
\begin{minipage}[t]{\linewidth}
En el gráfico adjunto se representa la percepción ciudadana respecto de los atributos de un candidato.\\
...
\item
\begin{minipage}[t]{\linewidth}
La masa molar del ácido sulfúrico se calcula sumando las masas molares de todos los átomos que lo conforman.\\
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item $(1+32+16)\,\dfrac{\mathrm{g}}{\mathrm{mol}}$
\item $(2+4)\cdot(32+16)\,\dfrac{\mathrm{g}}{\mathrm{mol}}$
\item $(2\cdot 1+1\cdot 32+4\cdot 16)\,\dfrac{\mathrm{g}}{\mathrm{mol}}$
\item $(1+2+4)\cdot(1+32+16)\,\dfrac{\mathrm{g}}{\mathrm{mol}}$
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
Si al entero $-1$ le restamos el entero $-4$, resulta: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
La expresión $(9\cdot 4)$ es divisor de: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $P+3$ es el sucesor del número $10$, entonces el sucesor de $P$ es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si al número $-8$ se le resta el doble de $-6$ y al resultado se le agrega el cubo de $-3$, resulta: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $|P|$ representa el valor absoluto de $P$, ¿cuál de las siguientes alternativas es verdadera?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $m=-1$ y $n=2$, ¿cuál es el valor de $m\cdot(n-m)\cdot(m-n)$?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item El número 2 es compuesto.
\item El número 1 es primo.
\item El m.c.m. entre 2, 3 y 11 es la suma entre 2, 3 y 11.
\item El M.C.D. entre 2, 11 y 19 es 1.
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
La temperatura mínima de un día fue de $-1^\circ\mathrm{C}$ y la máxima de $9^\circ\mathrm{C}$. ¿Cuál fue la variación de temperatura del día?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si un fontanero cobra \$500 por reparar cada fuga de agua en una tubería, ¿cuánto cobraría por reparar tres fugas en tuberías separadas?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
¿Qué resultado se obtiene si se disminuye en 2 unidades la suma entre el triple de 2 y el doble de 3?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $N$ es divisor de 8 y $N$ no es divisor de 4, entonces $N$ es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item La suma de números naturales siempre es natural.
\item La sustracción es conmutativa en los naturales.
\item En los naturales, el inverso aditivo de 2 es $-2$.
\item En los enteros, el inverso multiplicativo de 1 es $-1$.
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
Si $x$ es un número primo, entonces $x^2$ es siempre: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
El valor de la expresión $18-(-30):(-2)+(-2)\cdot(-1)$ es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
El doble de $(2\cdot(4+3)-2\cdot(1-2))=$\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $n$ es un número natural par, entonces el sucesor par del sucesor de $n+1$ está representado por: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $p=-6$ y $q=-2$, entonces $-\{p+q-(q-p)\}$ es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
El valor de $24:8\cdot 6:3-45:9\cdot 3-4:(-2)$ es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si el sucesor de un número es $a+4$, entonces el doble del número es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
La suma de tres números pares consecutivos es siempre divisible por: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
La edad de Lucas equivale al doble de la quinta parte de la semisuma entre 4 y 6. ¿Qué edad tiene Lucas?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Javiera guarda monedas de \$100 en una alcancía. Si le faltan 3 monedas para tener \$5.000, ¿a cuántas monedas de \$50 equivale el dinero que tiene Javiera?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Con 5 vasos de 250 ml cada uno se llena un jarro. ¿Cuántos vasos de 125 ml se necesitan para llenar dos jarros iguales?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
¿Cuál de los siguientes pares de dígitos podrían ponerse en los espacios vacíos para que el número $4\square.\square 12$ sea divisible por 6?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
$M=12C4$ representa a un número de 4 cifras divisible por 6. ¿Qué valores puede tener el dígito $C$?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $a+b+c=2d$, donde $a=5$, $b=4$ y $c=-3$, entonces el valor de $d\cdot d\cdot(d-a)\cdot(d-b)\cdot(d-c)$ es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Tenemos cuatro sitios de 70, 56, 42 y 84 hectáreas. Si queremos subdividirlos en parcelas de igual superficie, la superficie máxima posible de cada parcela es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item En los enteros, la sustracción es conmutativa.
\item En los enteros, el inverso multiplicativo de 10 es 0,1.
\item En los enteros, el neutro aditivo es el cero.
\item En los enteros, la división es conmutativa.
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
Si el antecesor de un número es $c-5$, entonces el cuádruple del número es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si al cuadrado de $-3$ se le resta el doble de $-4$ y al resultado se le agrega el triple de 3, se obtiene: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si 14 veces 2 es igual a $M$ y 15 veces 3 es igual a $N$, entonces $M+N$ resulta: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $a$ y $b$ son números primos distintos, ¿cuál de las siguientes opciones podría ser el producto de $a$ y $b$?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $a$ y $b$ son enteros, el antecesor de $a$ es $b$ y el sucesor de $a$ es $-9$, entonces $a+b=$\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
El producto entre los divisores positivos de 12 es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Se sabe que $n$ es múltiplo de 2. ¿Cuál de las siguientes afirmaciones es verdadera?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item El sucesor de $n$ es múltiplo de 3.
\item $n^3$ es múltiplo de 3.
\item $12n$ es múltiplo de 2.
\item $n+5$ es múltiplo de 2.
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
Si la suma entre el menor y el mayor de cinco números impares consecutivos es 1.854, ¿cuál es su diferencia positiva?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si la suma de tres números enteros consecutivos es 453, ¿cuál es el producto entre los dos mayores?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
En un cumpleaños se deben armar cajitas sorpresa con chocolates, Guagüitas y Sunys. Se compra un paquete de cada uno con 100, 75 y 50 unidades, respectivamente. ¿Cuántas cajitas se pueden armar como máximo, todas con la misma cantidad de cada producto?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
En un circuito de carreras de juguetes, tres autos parten al mismo tiempo desde la meta. El auto rojo tarda 120 s, el azul 140 s y el verde 180 s en dar una vuelta completa. ¿En cuántos segundos volverán a pasar juntos por la línea de partida?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Todo el líquido de una jarra se reparte en 14 vasos iguales llenos hasta su capacidad máxima. Se quiere verter la misma cantidad de líquido de otra jarra idéntica en vasos iguales, pero solo hasta la mitad de su capacidad. ¿Cuántos vasos más se necesitarán?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
El reloj despertador de Antonio suena cada 30 minutos y su aplicación de noticias envía notificaciones cada 10 minutos. Si a las 8:00 AM ambos coinciden por primera vez en el día, ¿a qué hora coincidirán por quinta vez?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Mila necesita vender 294 cajas de chocolates en 1 año. Si cada mes venderá 3 cajas más que el mes anterior, ¿cuántas cajas venderá el último mes?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Una aplicación informa la temperatura cada 40 minutos y el tiempo de llegada de un transporte público cada 12 minutos. Si a las 7:00 AM ambas informaciones coinciden por primera vez, ¿a qué hora coinciden por tercera vez?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
En un juego de cartas un jugador obtiene 27 puntos a favor y 4 en contra. Su puntaje final se obtiene restando a los puntos a favor el doble de los puntos en contra. ¿Cuál es su puntaje final?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
¿Cuál es la cifra de la unidad de $4^{55}$?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Se necesita comprar un balde para vaciar tres estanques cuyas capacidades aparecen en la figura. Se desea hacer el menor número de extracciones y que el balde se llene al máximo cada vez. ¿Qué capacidad debe tener el balde?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $a$ es par y $b$ es impar, ¿cuál de las siguientes expresiones representa un número par?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Dos luces intermitentes se encienden con intervalos de 42 y 54 segundos. Si a las 10:15 ambas están encendidas, ¿a qué hora estarán nuevamente encendidas simultáneamente?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item 10 h 21 min 18 s
\item 10 h 21 min 36 s
\item 10 h 21 min 42 s
\item 10 h 15 min 54 s
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
Una habitación se encuentra a $7^\circ\mathrm{C}$. Si una estufa aumenta la temperatura en $2^\circ\mathrm{C}$ cada 10 minutos, ¿en cuánto tiempo llegará a $21^\circ\mathrm{C}$?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Victoria tiene \$38.000 en efectivo, gasta \$4.500 en una entrada al cine, retira \$20.000 de su cuenta y compra un regalo de \$12.000. ¿Qué expresión permite calcular el dinero en efectivo que le queda?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Sean $a>b$ y $b>c$, siendo $a$, $b$ y $c$ números enteros. Si $b=0$, ¿cuál de las siguientes relaciones es verdadera?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Se puede determinar que el número entero $p$ es par si: \\ (1) El doble de $p$ es par. \\ (2) El quíntuple de $p$ es par.\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $A$, $B$, $C$ y $D$ son enteros tales que $A>B$, $C>D$, $B<D$ y $C<A$, el orden decreciente es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
En una competencia de ciclismo, un corredor gana $A$ carreras y pierde $B$ carreras. Su puntaje final se obtiene restando a las carreras ganadas el triple de las perdidas. ¿Cuál es su puntaje final?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $A^{*}=A^2+1$, entonces $\left(3^{*}+1\right)^{*}=$\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $a$ y $b$ son enteros y la suma de $a\cdot b$ y $b$ es impar, ¿qué aseveración es verdadera?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item $a$ y $b$ son pares.
\item $a$ y $b$ son impares.
...
\item
\begin{minipage}[t]{\linewidth}
Sea $n$ un número entero. La expresión $3\cdot(3+n)$ representa un múltiplo de 6 si: \\ (1) $n$ es impar. \\ (2) $n+1$ es par.\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
¿Qué valor toma la expresión $-b^2\cdot a^{-3}$ cuando $a=-3$ y $b=-2$?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item El 1 es un número compuesto.
\item Todo número entero elevado a cero es 1.
\item El 1 es múltiplo de todos los enteros.
\item El 1 es divisor de todos los naturales.
\item El 1 es el neutro aditivo en los enteros.
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
Sean los enteros $a$, $b$ y $c$. Se puede determinar cuál de ellos es el menor si: \\ (1) $a-b<0$. \\ (2) $a-c>0$.\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si el sucesor de un número es $m+3$, entonces el doble del antecesor del número es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $m$ y $n$ son dos enteros consecutivos tales que $m<n$, entonces $n-m$ es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Si $N$ es un número entero, ¿cuál de las siguientes afirmaciones es verdadera?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\begin{minipage}{0.95\linewidth}
\begin{alternativas}
\item $(N^2-1)$ es el entero antecesor del cuadrado de $N$.
\item $-(N-1)$ es el antecesor de $N$.
\item $(N+1)^2$ es el sucesor del cuadrado de $N$.
\item $2N-2$ es el antecesor del doble de $N$.
\end{alternativas}
\end{minipage}
};
\node (figura) at (7,0) {\begin{minipage}{0.42\linewidth}
...
\item
\begin{minipage}[t]{\linewidth}
Se puede asegurar que $P$ es divisible por 8 si: \\ (1) Sus últimas cuatro cifras son ceros. \\ (2) Su última cifra es par.\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Sean $a$, $b$, $c$ y $d$ cuatro números primos distintos. El recíproco del cociente entre el máximo común divisor y el mínimo común múltiplo entre ellos es: \\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Una persona debe reunir $A$ pesos. Primero reúne $B$ pesos y luego gasta $C$ pesos. ¿Cuánto le falta para completar el monto que necesita, si $A>B>C$?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Benjamín tiene ahorradas 12 monedas de \$50, 25 monedas de \$100 y el resto en monedas de \$500, de manera que en total tiene \$7.100. Si cambia todas las monedas de \$500 por monedas de \$50, ¿cuántas monedas tendrá en total?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
...
\item
\begin{minipage}[t]{\linewidth}
Los números siguientes ordenados de manera creciente son: 
\[
...
\item
\begin{minipage}[t]{\linewidth}
Ana tiene $X$ cantidad de dinero en efectivo, gasta $A$ en un almuerzo, luego retira de su cuenta bancaria $B$ y compra un libro por $C$. ¿Qué expresión calcula el dinero en efectivo que le queda?\\
\\%--------------------------------------
\begin{minipage}{\linewidth}
\vspace{7mm}
\begin{tikzpicture}[every node/.style={anchor=north west}]
